...
public class Users extends TableImpl<UsersRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.USER_ID_UINDEX, Indexes.USERS_LOGIN_UINDEX);
    }
    ...
    public List<ForeignKey<UsersRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USERS__USERS_ROLE_NAME_FK);
    }
    ...
    public Role role() {
        if (_role == null)
            _role = new Role(this, Keys.USERS__USERS_ROLE_NAME_FK);
